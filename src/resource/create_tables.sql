...
CREATE TABLE class_info (
    ...
    room_number TEXT NOT NULL UNIQUE, -- 教室编号
...
CREATE TABLE course_schedule (
    ...
    day_of_week INTEGER NOT NULL,     -- 星期（1-7）
...
CREATE TABLE notices (
    ...
    is_scrolling INTEGER DEFAULT 0,   -- 是否滚动（1=是，0=否）
    is_valid INTEGER DEFAULT 1        -- 是否有效（1=是，0=否）
);
